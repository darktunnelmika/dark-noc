...
assert '/static/mobile.css?v=2.9.47' in index
assert '/static/mobile-runtime.js?v=2.9.47' in index
assert index.index('/static/mobile.css?v=2.9.47') > index.index('/static/live-matrix.css')
assert index.index('/static/mobile-runtime.js?v=2.9.47') > index.index('/static/live-matrix.js')
...
assert 'VERSION = "2.9.47"' in (ROOT / 'hub/app.py').read_text(encoding='utf-8')
