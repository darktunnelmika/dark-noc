...
assert 'VERSION = "2.9.11"' in hub
assert 'VERSION = "2.9.11"' in agent
assert 'VERSION="2.9.11"' in cli
assert "Nightfall Command v2.9.11" in installer
assert "Zero-touch Node v2.9.11" in node_installer
assert "app.js?v=2.9.11" in index
...
assert "fresh v2.9.11 heartbeat" in installer
...
assert "fresh v2.9.11 post-upgrade pulse" in hub_upgrade_success
