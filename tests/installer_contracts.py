...
assert 'VERSION = "2.9.14"' in hub
assert 'VERSION = "2.9.14"' in agent
assert 'VERSION="2.9.14"' in cli
assert "Nightfall Command v2.9.14" in installer
assert "Zero-touch Node v2.9.14" in node_installer
assert "app.js?v=2.9.14" in index
...
assert "fresh v2.9.14 heartbeat" in installer
...
assert "fresh v2.9.14 post-upgrade pulse" in hub_upgrade_success
