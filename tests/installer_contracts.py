...
assert 'VERSION = "2.9.12"' in hub
assert 'VERSION = "2.9.12"' in agent
assert 'VERSION="2.9.12"' in cli
assert "Nightfall Command v2.9.12" in installer
assert "Zero-touch Node v2.9.12" in node_installer
assert "app.js?v=2.9.12" in index
...
assert "fresh v2.9.12 heartbeat" in installer
...
assert "fresh v2.9.12 post-upgrade pulse" in hub_upgrade_success
