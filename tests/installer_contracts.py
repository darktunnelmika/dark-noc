...
assert 'VERSION = "2.9.39"' in hub
assert 'VERSION = "2.9.39"' in agent
assert 'VERSION="2.9.39"' in cli
assert "Nightfall Command v2.9.39" in installer
assert "Zero-touch Node v2.9.39" in node_installer
assert "app.js?v=2.9.39" in index
...
assert "fresh v2.9.39 heartbeat" in installer
...
assert "fresh v2.9.39 post-upgrade pulse" in hub_upgrade_success
