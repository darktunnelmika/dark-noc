...
assert 'VERSION = "2.9.44"' in hub
assert 'VERSION = "2.9.44"' in agent
assert 'VERSION="2.9.44"' in cli
assert "Nightfall Command v2.9.44" in installer
assert "Zero-touch Node v2.9.44" in node_installer
assert "app.js?v=2.9.44" in index
...
assert "fresh v2.9.44 heartbeat" in installer
...
assert "fresh v2.9.44 post-upgrade pulse" in hub_upgrade_success
