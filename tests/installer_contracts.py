...
assert 'VERSION = "2.9.22"' in hub
assert 'VERSION = "2.9.22"' in agent
assert 'VERSION="2.9.22"' in cli
assert "Nightfall Command v2.9.22" in installer
assert "Zero-touch Node v2.9.22" in node_installer
assert "app.js?v=2.9.22" in index
...
assert "fresh v2.9.22 heartbeat" in installer
...
assert "fresh v2.9.22 post-upgrade pulse" in hub_upgrade_success
