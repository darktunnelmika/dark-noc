...
assert 'VERSION = "2.9.21"' in hub
assert 'VERSION = "2.9.21"' in agent
assert 'VERSION="2.9.21"' in cli
assert "Nightfall Command v2.9.21" in installer
assert "Zero-touch Node v2.9.21" in node_installer
assert "app.js?v=2.9.21" in index
...
assert "fresh v2.9.21 heartbeat" in installer
...
assert "fresh v2.9.21 post-upgrade pulse" in hub_upgrade_success
