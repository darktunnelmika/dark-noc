...
assert 'VERSION = "2.9.13"' in hub
assert 'VERSION = "2.9.13"' in agent
assert 'VERSION="2.9.13"' in cli
assert "Nightfall Command v2.9.13" in installer
assert "Zero-touch Node v2.9.13" in node_installer
assert "app.js?v=2.9.13" in index
...
assert "fresh v2.9.13 heartbeat" in installer
...
assert "fresh v2.9.13 post-upgrade pulse" in hub_upgrade_success
