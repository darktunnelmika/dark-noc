...
assert 'VERSION = "2.9.25"' in hub
assert 'VERSION = "2.9.25"' in agent
assert 'VERSION="2.9.25"' in cli
assert "Nightfall Command v2.9.25" in installer
assert "Zero-touch Node v2.9.25" in node_installer
assert "app.js?v=2.9.25" in index
...
assert "fresh v2.9.25 heartbeat" in installer
...
assert "fresh v2.9.25 post-upgrade pulse" in hub_upgrade_success
